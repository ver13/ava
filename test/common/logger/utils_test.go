...
func LogMsgs() {
	logrus.Debugln("Sample debug 1.")
	logrus.WithFields(logrus.Fields{"name": formatter.CallerName(1), "a": "b", "c": 10}).Debug("Sample debug 2.")
	logrus.Infoln("Sample info 1.")
	logrus.WithFields(logrus.Fields{"name": formatter.CallerName(1), "a": "b", "c": 10}).Info("Sample info 2.")
	logrus.Warnln("Sample warn 1.")
	logrus.WithFields(logrus.Fields{"name": formatter.CallerName(1), "a": "b", "c": 10}).Warn("Sample warn 2.")
	logrus.Errorln("Sample error 1.")
	logrus.WithFields(logrus.Fields{"name": formatter.CallerName(1), "a": "b", "c": 10}).Error("Sample error 2.")
}
